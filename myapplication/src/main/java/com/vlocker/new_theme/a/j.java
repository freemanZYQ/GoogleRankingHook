...
public class j extends a implements a {
    ...
    public j(AbstractHttpClient abstractHttpClient, HttpContext httpContext, i iVar, String str, b bVar) {
        this.d = abstractHttpClient;
        this.e = httpContext;
        this.h = iVar;
        this.k = str;
    ...
    private void a(HttpResponse httpResponse, HttpUriRequest httpUriRequest) {
        ...
        try {
            ...
            if (entity != null) {
                ...
                com.vlocker.theme.model.b a = this.f.a(entity, this, this.k);
                if (this.l != null) {
                    try {
                        a = this.l.b((String) a);
                    } catch (Exception e) {
