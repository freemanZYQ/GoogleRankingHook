...
public abstract class a {
    ...
    public static final Executor b = (x.a() ? new h() : Executors.newSingleThreadExecutor(d));
    public static final Executor c = (x.b() ? Executors.newFixedThreadPool(6, d) : Executors.newFixedThreadPool(3, d));
