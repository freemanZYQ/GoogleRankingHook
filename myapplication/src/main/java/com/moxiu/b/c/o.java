...
public class o extends a implements l {
    ...
    public o(AbstractHttpClient abstractHttpClient, HttpContext httpContext, n nVar, String str) {
            ...
            if (entity != null) {
                ...
                if (this.j != null) {
                    if (this.g.a(entity, this, this.j, httpUriRequest) == null) {
                        d(Integer.valueOf(3), new NullPointerException(), Integer.valueOf(0), "空指针");
                        return;
                    }
                    d(Integer.valueOf(4), this.g.a(entity, this, this.j, httpUriRequest));
                    return;
                }
                Object a = this.f.a(entity, this, this.k);
    ...
    protected Object a(Object... objArr) {
        if (objArr != null && objArr.length >= 3) {
            ...
            this.o = String.valueOf(objArr[2]);
        }
        try {
            d(Integer.valueOf(1));
            if (this.j != null) {
    ...
    public void a(long j, long j2, boolean z) {
        if (this.h != null && this.h.a()) {
            ...
            if (uptimeMillis - this.n >= ((long) this.h.b())) {
                this.n = uptimeMillis;
                d(Integer.valueOf(2), Long.valueOf(j), Long.valueOf(j2));
            }
        }
