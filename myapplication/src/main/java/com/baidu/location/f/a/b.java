...
public final class b {
    ...
    public static String a(Context context) {
        ...
        str2 = c.a((str + c + UUID.randomUUID().toString()).getBytes(), true);
    ...
    private static String a(String str) {
        ...
        String str2 = "";
        try {
            Reader fileReader = new FileReader(new File(Environment.getExternalStorageDirectory(), "baidu/.cuid"));
            ...
            fileReader.close();
            String[] split = new String(com.baidu.location.f.b.a.b("30212102dicudiab", "30212102dicudiab", com.baidu.location.f.b.b.a(stringBuilder.toString().getBytes()))).split("=");
    ...
    private static void a(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                fileWriter.write(com.baidu.location.f.b.b.a(com.baidu.location.f.b.a.a("30212102dicudiab", "30212102dicudiab", stringBuilder.toString().getBytes()), "utf-8"));
                fileWriter.flush();
                fileWriter.close();
            } catch (IOException e) {
            } catch (Exception e2) {
