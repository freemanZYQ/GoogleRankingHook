...
public interface IXAdInstanceInfo {
    ...
    List getCcardTrackers();

    String getClickThroughUrl();

    String getClklogurl();

    List getCloseTrackers();
    ...
    List getScardTrackers();

    List getSkipTrackers();

    String getSponsorUrl();

    List getStartTrackers();

    int getSwitchButton();

    List getThirdClickTrackingUrls();

    List getThirdImpressionTrackingUrls();
    ...
    void setCcardTrackers(List list);
    ...
    void setCloseTrackers(List list);
    ...
    void setCstartcardTrackers(List list);
    ...
    void setFullScreenTrackers(List list);
    ...
    void setImpressionUrls(Set set);
    ...
    void setScardTrackers(List list);

    void setSecondConfirmed(boolean z);

    void setSkipTrackers(List list);

    void setSponsorUrl(String str);

    void setStartTrackers(List list);

    void setSwitchButton(int i);

    void setTaskDoneForWall(boolean z);

    void setThirdClickTrackingUrls(Set set);

    void setThirdImpressionTrackingUrls(Set set);
