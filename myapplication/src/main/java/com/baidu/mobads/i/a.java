...
public class a {
        ...
        public String a(int i) {
            ...
            while (i3 < size) {
                if (((ScanResult) this.a.get(i3)).level == 0) {
                    ...
                    str = str.replace(":", "");
                    if (this.b.k == null || !str.equals(this.b.k)) {
                        if (i4 < i) {
                            stringBuffer.append(IXAdRequestInfo.HEIGHT);
            ...
            obj2 = obj3;
            String str2 = a ? IXAdRequestInfo.HEIGHT + this.b.k + "km" + this.b.l : null;
    ...
    private String a(int i) {
        ...
        return a.equals("Z") ? null : a(a + "t" + System.currentTimeMillis() + this.m);
    }
    ...
    private static String a(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            ...
            int i4 = i3 >> 6;
            cArr[i + 2] = n[obj != null ? 63 - (i4 & 63) : 64];
            i3 = i4 >> 6;
            cArr[i + 1] = n[63 - (i3 & 63)];
    ...
    private com.baidu.mobads.i.a.a b() {
        /*
        r5 = this;
        r1 = 0;
