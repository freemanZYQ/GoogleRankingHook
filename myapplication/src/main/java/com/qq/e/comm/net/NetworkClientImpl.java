...
public class NetworkClientImpl implements NetworkClient {
    ...
    class NetFutureTask extends FutureTask implements Comparable {
        private final Priority a;

        public NetFutureTask(NetworkClientImpl networkClientImpl, Callable callable, Priority priority) {
            super(callable);
            this.a = priority;
        }
    ...
    public Future submit(Request request, Priority priority) {
