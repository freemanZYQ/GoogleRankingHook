    ...
    public class Req extends BaseReq {
        ...
        public boolean checkArgs() {
            ...
            for (WXCardItem wXCardItem : this.cardArrary) {
                if (wXCardItem == null || wXCardItem.cardId == null || wXCardItem.cardId.length() > IXAdIOUtils.BUFFER_SIZE || (wXCardItem.cardExtMsg != null && wXCardItem.cardExtMsg.length() > IXAdIOUtils.BUFFER_SIZE)) {
                    return false;
                }
            }
            return true;
