...
public final class StorageUtils {
    ...
    public static boolean externalMounted() {
        ...
        LunaLog.e("external storage unmounted");
        return false;
    }
    ...
    public static String getRootPath(Context context, boolean onlyExternalStorage, String subdir) {
        ...
        String path = "/";
        if (file != null) {
            path = FileChooserUtils.separator(file.getAbsolutePath());
        }
        return path;
    }
    ...
    public static String getDownloadPath(Context context) throws Exception {
        ...
        return FileChooserUtils.separator(file.getAbsolutePath());
    }
    ...
    public static String getPrivatePath(Context context, String type) {
        ...
        if (file == null) {
            ...
            if (type == null) {
                ...
                file = new File(FileChooserUtils.separator(context.getFilesDir().getAbsolutePath()) + type);
                //noinspection ResultOfMethodCallIgnored
                file.mkdirs();
            }
        }
    ...
    public static String getInternalRootPath(Context context) {
        return FileChooserUtils.separator(context.getFilesDir().getAbsolutePath());
    }
    ...
    public static String getCachePath(Context context, String type) {
        ...
        return FileChooserUtils.separator(file != null ? file.getAbsolutePath() : null);
    }
