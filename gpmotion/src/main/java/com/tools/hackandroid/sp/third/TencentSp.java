 ...
 * 腾讯相关
 */
public class TencentSp extends AbsSp {

	public static final String MTA_MID = "mid";
	...
	protected void inputRandomData(Context context, SharedPreferences sharedPreferences) {
		SharedPreferences.Editor mSpEditor = sharedPreferences.edit();
		mSpEditor.putString(MTA_MID, RandomUtil.newRandomString(RandomUtil.LOWER_CASE_STRING + RandomUtil.NUMBER_STRING, 40));
		mSpEditor.apply();
	}
